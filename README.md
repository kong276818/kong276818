...
재직 기간: 2025. 07 – 2025. 09 (3개월)

주요 역할: 초분광 카메라(Hyperspectral Camera) 기반 데이터 분석 및 AI 모델링

수행 업무 및 성과:

초분광 이미징 데이터를 활용한 객체 인식 및 상태 분석 알고리즘 연구

가시광선 범위를 넘어선 분광 정보를 분석하여 특정 대상의 특성(성분, 재질 등) 추출 프로세스 구축

초분광 데이터 특유의 고차원 데이터를 효율적으로 처리하기 위한 전처리 파이프라인 최적화
...
1.  (Under Review / In Preparation) - Focus: Dual-MoE (SERVO-MoE) optimization for Large Language Models.
2.  Implemented "Diet MoE" techniques to enhance efficiency and performance in sparse expert models.
3.  soon
